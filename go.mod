...
require (
	github.com/dana-team/container-app-operator v0.3.1
...
require (
	...
	github.com/dana-team/nfspvc-operator v0.4.1 // indirect
	github.com/dana-team/provider-dns v0.1.0 // indirect
